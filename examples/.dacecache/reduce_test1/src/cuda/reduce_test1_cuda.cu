...
DACE_DFI void reduce_test1_5_4_7_8_0_0_6(const double * __tmp_10_25_r_in_from_2_0, double& __tmp_11_12_w) {
    double value;
...
DACE_DFI void reduce_test1_5_4_12_8_0_0_10(double& __tmp_13_37_r, double * __tmp_15_16_w, long long threadIdx_x) {
...
void __dace_runkernel_assign_4_4_map_0_1_2(reduce_test1_t *__state, double * __restrict__ gpu___return)
{
...
__global__ void reduce_test1_5_0_0_0(double * __restrict__ gpu___return, const double * __restrict__ gpu_inputs) {
    {
        {
                ...
                {
                    {
                        ...
                        if (threadIdx_x < 32) {
                            if (threadIdx_y < 32) {
                                reduce_test1_5_4_7_8_0_0_6(&gpu_inputs[((((32 * blockIdx_x) + (4096 * blockIdx_y)) + threadIdx_x) + (128 * threadIdx_y))], shared[((32 * threadIdx_x) + threadIdx_y)]);
                            }
                        }
                    }
                }
                ...
                {
                    {
                        ...
                        if (threadIdx_x < 32) {
                            if (threadIdx_y < 32) {
                                reduce_test1_5_4_12_8_0_0_10(shared[(threadIdx_x + (32 * threadIdx_y))], &gpu___return[((32 * blockIdx_x) + threadIdx_y)], threadIdx_x);
                            }
                        }
                    }
                }
...
void __dace_runkernel_reduce_test1_5_0_0_0(reduce_test1_t *__state, double * __restrict__ gpu___return, const double * __restrict__ gpu_inputs)
{

    void  *reduce_test1_5_0_0_0_args[] = { (void *)&gpu___return, (void *)&gpu_inputs };
    cudaLaunchKernel((void*)reduce_test1_5_0_0_0, dim3(int_ceil(4, 1), int_ceil(2, 1), 1), dim3(32, 32, 1), reduce_test1_5_0_0_0_args, 0, __state->gpu_context->streams[0]);
}
